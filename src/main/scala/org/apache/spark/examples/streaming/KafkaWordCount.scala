...
object KafkaWordCount {
  ...
  def main(args: Array[String]): Unit={
    ...
    */
    ...
    ssc.checkpoint("file:///Users/shiyuan/Desktop/mei/checkpoint")  //这里表示把检查点文件写入分布式文件系统HDFS，所以要启动Hadoop
    ...
    val wordCounts = words.map(x => (x, 1L))
      ...
      if(rdd.count !=0 ){
        ...
        val message = new ProducerRecord[String, String]("results", null, str)
        // 给Kafka发送消息
